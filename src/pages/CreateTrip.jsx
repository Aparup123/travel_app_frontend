    ...
    <div className="flex justify-center">
      <div className="border p-4 mt-6 inline-block   ">
        ...
        <form className="md:grid grid-cols-2 gap-y-3" onSubmit={createTrip}>
          ...
          <input type="text" id="trip_title" className="p-0" onChange={(e)=>{setTrip({...trip, title:e.target.value})}} />
          <label htmlFor="location" className="block">location</label>
          <input id="location" type="text" onChange={(e)=>{setTrip({...trip, location:e.target.value})}}/>
          ...
          <input id="price" type="number" onChange={(e)=>{setTrip({...trip, price:e.target.value})}}/>
